...
* Enhancement: Export all user's emails to CRM in Cloud
* Bug fix: Exporting users, opportunities non updated in CRM in Cloud with WC order synchronization not activated
