...
if ( isset( $_POST['crmfwc-wc-nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['crmfwc-wc-nonce'] ) ), 'crmfwc-wc' ) ) {
...
<form name="crmfwc-wc" class="crmfwc-form"  method="post" action="">
	...
	<table class="form-table">
		<tr class="wc-export-orders">
			...
			<td>
				<input type="checkbox" name="crmfwc-wc-export-orders" value="1"<?php echo 1 === intval( $wc_export_orders ) ? ' checked="checked"' : ''; ?>>
		...
		<tr class="wc-split-opportunities">
			...
			<td>
				<input type="checkbox" name="crmfwc-wc-split-opportunities" value="1"<?php echo 1 === intval( $wc_split_opportunities ) ? ' checked="checked"' : ''; ?>>
		...
		<tr class="wc-company-opportunities">
			...
			<td>
				<input type="checkbox" name="crmfwc-wc-company-opportunities" value="1"<?php echo 1 === intval( $wc_company_opportunities ) ? ' checked="checked"' : ''; ?>>
